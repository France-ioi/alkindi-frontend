...
import {defineSelector, defineView} from 'epic-linker';

export default function* () {

  yield defineSelector('AttemptTimelineSelector', function (state, _props) {
    const {user, round} = state.response;
    return {user, round};
  });

  yield defineView('AttemptTimeline', 'AttemptTimelineSelector', EpicComponent(self => {
    ...
    */
    ...
    const renderAttemptNotStarted = function (attempt) {
      const {round, team, user} = self.props;
